...
import image1 from '../../assets/Homepage/image1.jpg'; // Replace with your image path
import image2 from '../../assets/Homepage/image2.png'; // Replace with your image path
  ...
  return (
    <section className="bg-blue-200  px-4 sm:px-8 py-12 md:py-40 flex flex-col lg:flex-row items-center justify-between max-w-7xl mx-auto">
      ...
      <div className="w-full lg:w-1/2 text-center lg:text-left space-y-4 md:space-y-6 lg:ml-10">
        ...
        <button className="bg-purple-400 hover:bg-purple-500 text-white font-semibold py-2 px-6 rounded-full transition duration-300 transform hover:scale-105">
          Find Support
        </button>
      </div>

      {/* Right side: Overlapping images with rotation and positioning */}
